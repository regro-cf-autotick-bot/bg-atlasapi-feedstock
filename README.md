...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bg-atlasapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15397&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bg-atlasapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bg-atlasapi` can be installed with:

```
conda install bg-atlasapi
```

It is possible to list all of the versions of `bg-atlasapi` available on your platform with:
